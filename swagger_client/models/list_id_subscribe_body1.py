...
class ListIdSubscribeBody1(dict):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """ListIdSubscribeBody1 - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ListIdSubscribeBody1, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListIdSubscribeBody1):
            return False
